...
<head>
    ...
    <link rel="shortcut icon" href=".../../.../../img/Logo Baru.png">
    ...
    <link rel="stylesheet" href="<?php echo e(url('vendor/Magnific-Popup/dist/magnific-popup.css')); ?>">

    <!--  Owl-carousel css file  -->
    <link rel="stylesheet" href="<?php echo e(url('vendor/owl-carousel/css/owl.carousel.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('vendor/owl-carousel/css/owl.theme.default.min.css')); ?>">
...
<body>
                        ...
                        <div class="experience-area">
                            ...
                            <div class="d-flex flex-row flex-wrap call-area">
                                ...
                                <div class="call-now">
                                    ...
                                    <span class="font-roboto py-2">mail@raffidev.com</span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="services">
                                ...
                                <div class="card-body text-center">
                                    <h5 class="card-title text-uppercase blue-title">ux/ui desing</h5>
                                    <p class="card-text text-secondary white-title">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="services">
                                ...
                                <div class="card-body text-center">
                                    <h5 class="card-title text-uppercase blue-title">web design</h5>
                                    <p class="card-text text-secondary white-title">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="services">
                                ...
                                <div class="card-body text-center">
                                    <h5 class="card-title text-uppercase blue-title">seo optimize</h5>
                                    <p class="card-text text-secondary white-title">
                        ...
                        <div class="our-project">
                            <div class="img">
                                <a class="test-popup-link" href="../../img/portfolio/p6.jpg">
                                    <img src="../../img/portfolio/p6.jpg" alt="portfolio-6"
                                        class="img-fluid">
                                </a>
                            </div>
                            <div class="title py-4">
                                <h4 class="text-uppercase title-text">Together sign</h4>
                        ...
                        <div class="our-project">
                            <div class="img">
                                <a class="test-popup-link" href="../../img/portfolio/p7.jpg">
                                    <img src="../../img/portfolio/p7.jpg" alt="portfolio-7"
                                        class="img-fluid">
                                </a>
                            </div>
                            <div class="title py-4">
                                <h4 class="text-uppercase title-text">Green Heaven</h4>
                                <span class="text-secondary">Following, Portfolio</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="our-project">
                            <div class="img">
                                <a class="test-popup-link" href="../../img/portfolio/p8.jpg">
                                    <img src="../../img/portfolio/p8.jpg" alt="portfolio-8"
                                        class="img-fluid">
                                </a>
                            </div>
                            <div class="title py-4">
                                <h4 class="text-uppercase title-text">Fly Male</h4>
                                <span class="text-secondary">Following, Portfolio</span>
                            </div> -->
                        </div>
                    </div>
    ...
    <!-- <section id="follow">
        <footer class="footer-area">
            <div class="container">
                <div class="social text-center dark:text-wh">
                    ...
                    <a href="https://instagram.com/raffidev"><i class="fab fa-instagram"></i></a>
                    <a href="https://www.youtube.com/c/RaffiDev"><i class="fab fa-youtube"></i></a>
                    <a href="https://www.twitter.com/RaffiDev"><i class="fab fa-twitter"></i></a>
                </div>
       ...
       <!-- END CONTACT -->
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col">
                        <h4>company</h4>
                        <ul>
                            <li><a href="#about"></i> about us</a>
                            <li><a href="blog/"></i> blog</a>
                            <li><a href="#"></i> privacy policy</a>
                            <li><a href="#"></i> affiliate program</a>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>get help</h4>
                    ...
                    <div class="footer-col">
                        <h4>contact info</h4>
                        <ul>
                            <li><a href="https://wa.me/6285157868689"> <i class="fas fa-phone"></i> +62 851-5786-8689</a></li>
                            <li><a href="https://mailto:raffi@raffidev.com"> <i class="fas fa-envelope"></i> raffi@raffidev.com</a></li>
                    ...
                    <div class="footer-col">
                        ...
                        <div class="social-links">
                            <a href="https://wa.me/6285157868689"><i class="fab fa-whatsapp"></i></a>
                            <a href="https://"><i class="fab fa-twitter"></i></a>
                            <a href="https://instagram.com/raffidev"><i class="fab fa-instagram"></i></a>
                            <a href="https://github.com/RaffiDevYT"><i class="fab fa-github git"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--  Jquery js file  -->
        <script src="<?php echo e(url('public/js/jquery.3.4.1.js')); ?>"></script>

        <!--  Bootstrap js file  -->
        <script src="<?php echo e(url('public/js/js/bootstrap.min.js')); ?>"></script>

        <!--  isotope js library  -->
        <script src="<?php echo e(url('vendor/isotope/isotope.min.js')); ?>"></script>

        <!--  Magnific popup script file  -->
        <script src="<?php echo e(url('vendor/Magnific-Popup/dist/jquery.magnific-popup.min.js')); ?>"></script>

        <!--  Owl-carousel js file  -->
        <script src="<?php echo e(url('vendor/owl-carousel/js/owl.carousel.min.js')); ?>"></script>
...
</html><?php /**PATH C:\Users\clov\Desktop\raffidev-laravel\resources\views/index.blade.php ENDPATH**/ ?>